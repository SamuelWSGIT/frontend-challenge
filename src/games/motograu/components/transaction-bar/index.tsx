...
export default function TransactionBar({ variant }: Props) {
  ...
  return (
    <div className="h-full py-8">
      <div className="flex flex-col transaction-bar min-h-[400px] flex-1 grow h-full w-full p-3 rounded-md bg-black bg-opacity-60 border border-gray-600 border-opacity-80 relative ">
