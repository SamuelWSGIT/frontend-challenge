...
export const Chat = ({ show }: Props) => {
  ...
  return (
    <If condition={show}>
      <div className="w-80 mt-0 py-2 mx-4 mt-20 px-2 border-l border-gray-700 border-opacity-50 text-sm rounded-lg bg-black backdrop-blur-sm bg-opacity-30 chat-container absolute right-0 z-40  h-[50%] sm:h-[80%] md:h-[70%] lg:h-[60%]">
